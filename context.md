...
## PROJECT STRUCTURE
- The project must be created in a `/PWA` folder
...
1. **Add to tracker**: When I provide a new Figma link, automatically add it to **`/Users/benoitthiennard/Desktop/Disque/Code/carnet-ffp-2/figma-links.md`** following the existing format:
   ```markdown
...
### Building the Screen
2. **Read Figma links**: Get the screen designs from **`/Users/benoitthiennard/Desktop/Disque/Code/carnet-ffp-2/figma-links.md`**. The design must be as faithful as possible
3. **Read design guidelines**: Follow the guidelines in **`/Users/benoitthiennard/Desktop/Disque/Code/carnet-ffp-2/design/guidelines-components.md`**
4. **Follow existing styles**: Use the styles defined in **`/Users/benoitthiennard/Desktop/Disque/Code/carnet-ffp-2/PWA/src/styles/main.css`**
5. **Add components to existing structure**: The generated components should be added to the existing PWA folder structure. Do not create a new project for each screen; all screens are related and should be in the same project
...
### After Completion
8. **Mark as complete**: Once the design is implemented, add `- DONE` after the screen title in **`/Users/benoitthiennard/Desktop/Disque/Code/carnet-ffp-2/figma-links.md`**
...
### Development Setup
- Create a folder `/PWA` where the future designs will be added
